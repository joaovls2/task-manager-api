package com.joaovictor.todolist.task;

import com.joaovictor.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
        ...
        // Valida se a data de inicio da task é maior que a data atual
        ...
        // Valida se a data de início é antes da data de término
    ...
    // Listar taefas de user espécifico
    @GetMapping("/")
